...
public class CatSociety {
    public static void main(String[] args) {
        ...
        //tambahan buat cek history
        System.out.println("History Kucing Bangsawan");
        System.out.println(kucingBangsawan.history());

        System.out.println("History Kucing Rakyat");
        System.out.println(kucingRakyat.history());

        System.out.println("History Kucing Prajurit");
        System.out.println(kucingPrajurit.history());
    }
}
